[{capture append="oxidBlock_pageBody"}]
    ...
    <div class="min-h-screen flex flex-col justify-center text-center">
        <div class="container rounded h-100 align-items-center col-12 col-md-6 col-lg-6" style="width: 500px; background-color:white">
            <h1 class="mt-3 page-header text-center">[{oxmultilang ident="TWOFACTORAUTHBACKUPCODE"}]</h1>
            <span class="help-block">[{oxmultilang ident="MESSAGE_TWOFACTOR_BACKUPCODE"}]</span>
            <h1 style="font-family: 'HelveticaNeue-Light'" class="mt-3">[{$oView->generateBackupCode()}]</h1>
