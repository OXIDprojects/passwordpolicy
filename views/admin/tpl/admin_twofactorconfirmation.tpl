...
<div class="container rounded h-100 align-items-center col-12 col-md-6 col-lg-6" style="width: 500px; background-color:white">
    ...
    <div class="hidden">
        ...
        <input type="hidden" name="cl" value="admin_twofactorconfirmation">
    </div>
    <div class="mt-3 flex justify-center " id="OTPInput">
    </div>
    <input hidden id="otp" name="otp" value="">
        <a href="?cl=admin_twofactorrecovery">[{oxmultilang ident="OXPS_PASSWORDPOLICY_TWOFACTORAUTH_HELP_LOST"}]</a>
    <div class="flex justify-center">
            <button id="accUserSaveTop" type="submit" name="save" class="mt-3 btn btn-primary">[{oxmultilang ident="OXPS_PASSWORDPOLICY_TWOFACTORAUTH_DEACTIVATE"}]</button>
</div>
</form>
</div>
</div>
