 ...
 */
class PasswordPolicyLanguage extends PasswordPolicyLanguage_parent
{
    protected function _getAdminLangFilesPathArray($iLang)
    {

        $aLangFiles = parent::_getLangFilesPathArray($iLang);
        return array_merge($aLangFiles,parent::_getAdminLangFilesPathArray($iLang));
    }
}
