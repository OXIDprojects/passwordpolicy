...
for (let i = 0; i < $otp_length; i++) {
    ...
    inputField.className = "w-12 h-12 bg-gray-100 border-gray-200 outline-none focus:bg-gray-200 m-2 text-center rounded focus:border-blue-400 focus:shadow-outline";
